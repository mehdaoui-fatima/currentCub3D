...
void	texture(t_cub3d *cubdata)
{
	...
	// W 
	cubdata->texture[0].image_ptr = mlx_xpm_file_to_image(cubdata->connection, cubdata->tex.west, &cubdata->texture[0].w, &cubdata->texture[0].h);
	...
	//E
	cubdata->texture[1].image_ptr = mlx_xpm_file_to_image(cubdata->connection, cubdata->tex.east, &cubdata->texture[1].w, &cubdata->texture[1].h);
	...
	//north 
	cubdata->texture[2].image_ptr = mlx_xpm_file_to_image(cubdata->connection, cubdata->tex.north, &cubdata->texture[2].w, &cubdata->texture[2].h);
	...
	// South
	cubdata->texture[3].image_ptr = mlx_xpm_file_to_image(cubdata->connection,cubdata->tex.south, &cubdata->texture[3].w, &cubdata->texture[3].h);
	...
	cubdata->texture[4].image_ptr = mlx_xpm_file_to_image(cubdata->connection,cubdata->tex.sprite, &cubdata->texture[4].w, &cubdata->texture[4].h);
